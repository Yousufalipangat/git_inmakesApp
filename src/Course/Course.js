            ...
            <View style={course_style.container}>
                ...
                <ScrollView contentContainerStyle={course_style.courseList_container}>
                    {Biology_chapters.chapter_list.map((chapter) => {
                        ...
                        return (
                            <View key={chapter.chapterNo} style={{ width: '100%', height: 140, backgroundColor: 'white', marginVertical: 10, borderRadius: 10, elevation: 2, padding: 15 }}>
                                <View>
                                    <Text style={{ fontWeight: 'bold', fontSize: 20, color: 'rgb(31,62,76)' }} onPress={()=>this.props.navigation.navigate('Chapter')} >Long Chapter name can be shown here</Text>
                                </View>
